...
//  via Arcade-Fuuki_MiSTer. Author: Umberto Parisi (rmonic79), GPL v3 or
//  later. One local change: hoff_s's zero branch is $signed, otherwise the
//  ternary is unsigned, hoffset zero-extends and negative H-Position blanks
//  the picture (sim/seta_crt_tb). Otherwise re-vendor, do not edit.
//  rtl/video/seta_crt.sv wires H-Position, V-Shift, H-Size and CRT width,
//  with its own read-rate generator for pxl2_cen.
//============================================================================
//============================================================================
