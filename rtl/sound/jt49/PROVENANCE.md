...
**In this repository:** copied from Arcade-Fuuki_MiSTer's `rtl/sound/jt49/` at its commit 8e70617, unchanged, for Thundercade's YM2203 (jt03) and YM3812 (jtopl2) on the Seta_Downtown core. The notes below are that repository's.

**In this repository:** copied on 2026-09-06 from the Psikyo core's `rtl/sound/jt49/`, unchanged.
It is the SSG inside jt03 (YM2203). The notes below are Psikyo's.
